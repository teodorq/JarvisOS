...
from .software_engineer_diagnostics_router import (
    SoftwareEngineerDiagnosticsRouter,
)
from .software_engineer_learning_router import (
    SoftwareEngineerLearningRouter,
)
from .software_engineer_long_running_router import (
    SoftwareEngineerLongRunningRouter,
)
from .software_engineer_project_intelligence_router import (
    SoftwareEngineerProjectIntelligenceRouter,
)
from .software_engineer_self_directed_router import (
    SoftwareEngineerSelfDirectedRouter,
)
from .software_engineer_strategic_execution_router import (
    SoftwareEngineerStrategicExecutionRouter,
)
from .software_engineer_strategic_development_router import (
...
class SoftwareEngineerAdvancedChangeRouter:
    ...
    def try_handle(
        ...
        *,
        ...
        for router in _DELEGATED_ROUTERS:
