...
from .software_engineer_strategic_development_router import SoftwareEngineerStrategicDevelopmentRouter
from .software_engineer_strategic_execution_router import SoftwareEngineerStrategicExecutionRouter
...
class AutonomousSoftwareEngineerController:
    ...
    COMMAND_PHRASES = (
        ...
        "change campaign",
        "resume campaign",
        "portfolio kampanii", "wiele kampanii", "multi campaign", "uczenie autonomii", "uczenia autonomii", "uczenie autonomiczne", "uczenia autonomicznego", "status uczenia", "status uczenia autonomicznego", "historia autonomii", "historia uczenia", "historia uczenia autonomicznego", "profil uczenia", "profil uczenia autonomicznego", "wersje profilu uczenia", "historia wersji profilu", "cofnij profil uczenia", "aktywuj wersję profilu", "aktywuj wersje profilu", "automatyczny trening", "automatyczne uczenie", "naucz jarvisa", "naucz jarvis-a", "zastosuj naukę", "zastosuj nauke", "autonomous learning",
        ...
        "długotrwała autonomia", "długotrwałą autonomię", "długotrwałej autonomii", "długa autonomia", "długiej autonomii", "dlugotrwala autonomia", "dluga autonomia", "dlugiej autonomii", "dlugotrwalej autonomii", "dlugotrwala autonomie", "nadzorca autonomii", "nadzorcę autonomii", "nadzorce autonomii", "harmonogram autonomii", "kolejka autonomii", "kolejkę autonomii", "kolejke autonomii", "zadanie długotrwałe", "zadanie dlugotrwale", "zadania długotrwałego", "zadania dlugotrwalego", "status zadania", "pokaż wszystkie zadania", "pokaz wszystkie zadania", "lista zadań autonomii", "lista zadan autonomii", "usuń zakończone zadania", "usun zakonczone zadania", "wyczyść zakończone zadania", "wyczysc zakonczone zadania", "wstrzymaj zadanie", "wznów zadanie", "wznow zadanie", "anuluj zadanie", "wykonaj teraz zadanie", "uruchom teraz zadanie", "usuń zadanie", "usun zadanie", "longrun-", "long running autonomy", "autonomy supervisor", "scheduled autonomy", "diagnostyka autonomii", "diagnostykę autonomii", "diagnostyke autonomii", "diagnostyka zadania", "diagnostykę zadania", "diagnostyke zadania", "wyjaśnij błąd zadania", "wyjasnij blad zadania", "raport błędów autonomii", "raport bledow autonomii", "historia napraw autonomii", "bezpieczna naprawa zadania", "bezpieczną naprawę zadania", "napraw zadanie longrun-", "spróbuj naprawić zadanie", "sprobuj naprawic zadanie", "autonomous diagnostics", "safe repair longrun-", "inteligencja projektu", "status inteligencji projektu", "backlog rozwoju", "zadanie rozwoju", "autonomiczny rozwój projektu", "autonomiczny rozwoj projektu", "skanuj projekt i zbuduj backlog", "przeskanuj projekt i zbuduj backlog", "cykl inteligencji projektu", "najlepsze zadanie rozwoju", "opportunity-", "project intelligence", "development backlog", "samodzielny rozwój", "samodzielny rozwoj", "status samodzielnego rozwoju", "historia samodzielnego rozwoju", "cykl samodzielnego rozwoju", "self directed development", "self-directed development", "wykonanie strategiczne", "status wykonania strategicznego", "historia wykonania strategicznego", "strategic execution",
    )
    ...
    def can_handle(
        ...
        return (
            SoftwareEngineerStrategicDevelopmentRouter.can_handle(normalized)
            or SoftwareEngineerStrategicExecutionRouter.can_handle(normalized)
            or any(phrase in normalized for phrase in cls.COMMAND_PHRASES)
        )
