...
class BrainResponseFormatter:
    ...
    def _format_software_engineer_response(
        ...
        if response.get(
            "operation"
        ) == "autonomy_governance_suite":
            return format_autonomy_governance_response(
                response
            )

        if response.get(
            "operation"
        ) == "strategic_policy_validation":
            return format_strategic_validation_response(
                response
            )
        ...
        if response.get(
            ...
            return format_strategic_policy_response(
                response
            )
        ...
        if response.get(
            ...
            return format_strategic_portfolio_response(
                response
            )
        ...
        if response.get(
            ...
            return format_strategic_execution_response(
                response
            )
        ...
        if response.get(
            ...
            return format_strategic_development_response(
                response
            )
        ...
        if response.get(
            ...
            return format_self_directed_development_response(
                response
            )
        ...
        if response.get(
            ...
            return format_project_intelligence_response(
                response
            )
        ...
        if response.get(
            ...
            return format_autonomous_diagnostics_response(
                response
            )
        ...
        if response.get(
            ...
            return format_long_running_autonomy_response(
                response
            )
